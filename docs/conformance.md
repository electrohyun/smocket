...
- [rejects an unmatched dynamic namespace as Invalid namespace](../src/dynamic-namespace.test.ts#L191)
- [retries dynamic admission after an earlier matcher rejection](../src/dynamic-namespace.test.ts#L204)
- [dynamic admission reads the current client.auth on a manual retry](../src/dynamic-namespace.test.ts#L222)
- [creates a child before middleware and snapshots parent setup at creation](../src/dynamic-namespace.test.ts#L240)
- [copies the parent connect synonym to a concrete child](../src/dynamic-namespace.test.ts#L277)
- [ignores duplicate client connect calls while async dynamic admission is pending](../src/dynamic-namespace.test.ts#L288)
- [cancels dynamic admission while callback-form auth is unresolved](../src/dynamic-namespace.test.ts#L314)
- [cancels unresolved dynamic matching with shared Manager disconnect(true)](../src/dynamic-namespace.test.ts#L351)
- [continues parent matching after a cancelled parent rejects late](../src/dynamic-namespace.test.ts#L395)
- [reuses one child for concurrent async same-name admissions](../src/dynamic-namespace.test.ts#L450)
- [broadcasts directly across children while child rooms and lifecycle stay isolated](../src/dynamic-namespace.test.ts#L479)
- [exposes narrowed parent operators without selecting their delivery result](../src/dynamic-namespace.test.ts#L514)
- [keeps shared Manager teardown connection-wide across dynamic children](../src/dynamic-namespace.test.ts#L525)
- [uses one concrete child for nextConnection, lookup, and Manager grouping](../src/dynamic-namespace.test.ts#L546)
- [creates a RegExp child when nextConnection observes it before a client connects](../src/dynamic-namespace.test.ts#L563)
- [keeps new_namespace available as an ordinary Socket payload event](../src/dynamic-namespace.test.ts#L580)
...
- [ignores duplicate connect calls while static namespace middleware is pending](../src/middleware.test.ts#L148)
- [io.of(nsp).use() runs only for connections on that namespace](../src/middleware.test.ts#L172)
- [two middlewares run in registration order](../src/middleware.test.ts#L190)
- [an error in the first middleware short-circuits the second](../src/middleware.test.ts#L205)
...
- [disconnect cancels a static connection while callback auth is unresolved](../src/handshake.test.ts#L49)
- [a reconnect replays the client-supplied auth on the fresh socket](../src/handshake.test.ts#L92)
- [a reconnect reads a replacement object from client.auth](../src/handshake.test.ts#L109)
- [a reconnect re-evaluates the current callback from client.auth](../src/handshake.test.ts#L125)
...
- [close disconnects every namespace with the shutdown reasons](../src/server-close.test.ts#L108)
- [close rejects a pending client emitWithAck](../src/server-close.test.ts#L142)
- [close leaves a pending server emitWithAck pending](../src/server-close.test.ts#L154)
- [close does not cancel an armed server acknowledgement timeout](../src/server-close.test.ts#L178)
