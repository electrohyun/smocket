...
- [a client timeout callback preserves every acknowledgement argument](../src/ack.test.ts#L60)
- [a server timeout callback preserves every acknowledgement argument](../src/ack.test.ts#L71)
- [timeout emitWithAck keeps the first-value Promise policy in both directions](../src/ack.test.ts#L82)
- [calling ack twice runs the sender callback only once](../src/ack.test.ts#L91)
- [discards retained acks in both directions after the client disconnects](../src/ack.test.ts#L107)
- [discards retained acks in both directions after the server Socket disconnects](../src/ack.test.ts#L133)
- [discards retained acks in both directions during server close](../src/ack.test.ts#L159)
- [emitWithAck stays pending when the peer never acks](../src/ack.test.ts#L176)
...
- [handshake.auth carries the client-supplied auth values](../src/handshake.test.ts#L26)
- [handshake.auth is a JSON snapshot of the CONNECT packet](../src/handshake.test.ts#L32)
- [handshake.query stringifies the client-supplied query values](../src/handshake.test.ts#L66)
- [handshake.auth accepts a function form, resolved via its callback](../src/handshake.test.ts#L74)
- [invokes callback-form auth after the client factory returns](../src/handshake.test.ts#L82)
- [disconnect cancels a static connection while callback auth is unresolved](../src/handshake.test.ts#L96)
- [a reconnect replays the client-supplied auth on the fresh socket](../src/handshake.test.ts#L139)
- [a reconnect reads a replacement object from client.auth](../src/handshake.test.ts#L156)
- [a reconnect re-evaluates the current callback from client.auth](../src/handshake.test.ts#L172)
...
- [drops direct sends from the old server Socket after a client disconnect](../src/disconnect.test.ts#L104)
- [drops direct sends from the old server Socket after a server disconnect](../src/disconnect.test.ts#L108)
- [a disconnected socket no longer receives emits for that room](../src/disconnect.test.ts#L112)
- [client connected and disconnected remain exact inverses across teardown](../src/disconnect.test.ts#L134)
- [a room disappears from the adapter when its last member disconnects](../src/disconnect.test.ts#L150)
- [whole-socket cleanup removes the sid from adapter membership](../src/disconnect.test.ts#L174)
- [a disconnected socket cannot join rooms again](../src/disconnect.test.ts#L188)
- [a reconnected socket does not automatically rejoin its previous rooms](../src/disconnect.test.ts#L208)
- [rooms are still present at disconnecting and empty at disconnect](../src/disconnect.test.ts#L235)
- [a pending client.emitWithAck rejects when the connection drops](../src/disconnect.test.ts#L258)
- [disconnect clears a pending client timeout before rejecting emitWithAck](../src/disconnect.test.ts#L270)
...
- [drains server packets queued before Server.close()](../src/queued-delivery-lifecycle.test.ts#L94)
- [preserves FIFO in both directions while the connection remains active](../src/queued-delivery-lifecycle.test.ts#L110)
